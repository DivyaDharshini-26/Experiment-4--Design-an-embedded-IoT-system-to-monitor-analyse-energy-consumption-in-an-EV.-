...
powerData = zeros(1, timeDuration); energyData = zeros(1, timeDuration);
...
<img width="699" height="625" alt="image" src="https://github.com/user-attachments/assets/0dab870f-f05a-47bd-9406-586b2039f12d" />
